  ...
  return (
    <div className="user-management-container">
      ...
      <div className="form-container">
        <form ref={frmRef} className="user-form">
          ...
          {editId ? (
            ...
            <button onClick={handleAdd} className="btn add-btn">Add</button>
          )}
        </form>
      </div>
      ...
      <div className="search-container">
        ...
        />
        <button onClick={() => fetchUsers()} className="btn search-btn">Search</button>
      </div>
          ...
          <tbody>
            {users.map((value) => (
              <tr key={value._id}>
                ...
                <td>{value.role}</td>
                <td>
                  <button onClick={() => handleEdit(value)} className="btn edit-btn">Edit</button>
                  <button onClick={() => handleDelete(value._id)} className="btn delete-btn">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
